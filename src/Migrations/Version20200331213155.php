...
final class Version20200331213155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, item_id, "key" FROM image');
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, "key" VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C53D045F126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO image (id, item_id, "key") SELECT id, item_id, "key" FROM __temp__image');
        ...
        $this->addSql('DROP INDEX IDX_C3C4C2712469DE2');
        $this->addSql('DROP INDEX IDX_C3C4C276593CE46');
        $this->addSql('CREATE TEMPORARY TABLE __temp__item_ad_category AS SELECT item_ad_id, category_id FROM item_ad_category');
        $this->addSql('DROP TABLE item_ad_category');
        $this->addSql('CREATE TABLE item_ad_category (item_ad_id INTEGER NOT NULL, category_id INTEGER NOT NULL, PRIMARY KEY(item_ad_id, category_id), CONSTRAINT FK_C3C4C276593CE46 FOREIGN KEY (item_ad_id) REFERENCES item_ad (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C3C4C2712469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO item_ad_category (item_ad_id, category_id) SELECT item_ad_id, category_id FROM __temp__item_ad_category');
        $this->addSql('DROP TABLE __temp__item_ad_category');
        $this->addSql('CREATE INDEX IDX_C3C4C2712469DE2 ON item_ad_category (category_id)');
        $this->addSql('CREATE INDEX IDX_C3C4C276593CE46 ON item_ad_category (item_ad_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, item_id, "key" FROM image');
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, "key" VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO image (id, item_id, "key") SELECT id, item_id, "key" FROM __temp__image');
        $this->addSql('DROP TABLE __temp__image');
        $this->addSql('CREATE INDEX IDX_C53D045F126F525E ON image (item_id)');
        $this->addSql('DROP INDEX IDX_1F1B251EF675F31B');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__item_ad_category AS SELECT item_ad_id, category_id FROM item_ad_category');
        $this->addSql('DROP TABLE item_ad_category');
        $this->addSql('CREATE TABLE item_ad_category (item_ad_id INTEGER NOT NULL, category_id INTEGER NOT NULL, PRIMARY KEY(item_ad_id, category_id))');
        $this->addSql('INSERT INTO item_ad_category (item_ad_id, category_id) SELECT item_ad_id, category_id FROM __temp__item_ad_category');
        $this->addSql('DROP TABLE __temp__item_ad_category');
        $this->addSql('CREATE INDEX IDX_C3C4C276593CE46 ON item_ad_category (item_ad_id)');
        $this->addSql('CREATE INDEX IDX_C3C4C2712469DE2 ON item_ad_category (category_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__request AS SELECT id, item_ad_id, item_name, item_description, min_price, max_price FROM request');
        $this->addSql('DROP TABLE request');
        $this->addSql('CREATE TABLE request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_ad_id INTEGER DEFAULT NULL, item_name VARCHAR(255) NOT NULL, item_description VARCHAR(255) NOT NULL, min_price INTEGER NOT NULL, max_price INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO request (id, item_ad_id, item_name, item_description, min_price, max_price) SELECT id, item_ad_id, item_name, item_description, min_price, max_price FROM __temp__request');
        $this->addSql('DROP TABLE __temp__request');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3B978F9F6593CE46 ON request (item_ad_id)');
        $this->addSql('DROP INDEX IDX_32993751F675F31B');
