 ...
 */
final class Version20200501214204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_ad_id INTEGER NOT NULL, min_price INTEGER NOT NULL, max_price INTEGER DEFAULT NULL)');
