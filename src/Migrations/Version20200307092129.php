 ...
 */
final class Version20200307092129 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ad AS SELECT id, author_id, item_id, title, description, price, is_on_sale, created_at, update_at FROM ad');
        ...
        $this->addSql('INSERT INTO ad (id, author_id, item_id, title, description, price, is_on_sale, created_at, update_at) SELECT id, author_id, item_id, title, description, price, is_on_sale, created_at, update_at FROM __temp__ad');
        ...
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, "key" VARCHAR(255) NOT NULL, CONSTRAINT FK_C53D045F126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO image (id, item_id, "key") SELECT id, item_id, url FROM __temp__image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_77E0ED58126F525E');
        $this->addSql('DROP INDEX IDX_77E0ED58F675F31B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ad AS SELECT id, item_id, author_id, title, description, price, is_on_sale, created_at, update_at FROM ad');
        $this->addSql('DROP TABLE ad');
        $this->addSql('CREATE TABLE ad (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, author_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, is_on_sale BOOLEAN NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO ad (id, item_id, author_id, title, description, price, is_on_sale, created_at, update_at) SELECT id, item_id, author_id, title, description, price, is_on_sale, created_at, update_at FROM __temp__ad');
        $this->addSql('DROP TABLE __temp__ad');
        $this->addSql('CREATE INDEX IDX_77E0ED58126F525E ON ad (item_id)');
        $this->addSql('CREATE INDEX IDX_77E0ED58F675F31B ON ad (author_id)');
        $this->addSql('DROP INDEX IDX_64C19C1727ACA70');
        ...
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, url VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO image (id, item_id, url) SELECT id, item_id, "key" FROM __temp__image');
        $this->addSql('DROP TABLE __temp__image');
        $this->addSql('CREATE INDEX IDX_C53D045F126F525E ON image (item_id)');
        $this->addSql('DROP INDEX IDX_1F1B251EF675F31B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, author_id, name, description, is_visible, created_at, update_at FROM item');
