 ...
 */
final class Version20200429122418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, item_id, "key", extension FROM image');
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id INTEGER DEFAULT NULL, "key" VARCHAR(255) NOT NULL COLLATE BINARY, extension VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C53D045F126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO image (id, item_id, "key", extension) SELECT id, item_id, "key", extension FROM __temp__image');
