 ...
 */
final class Version20200501184420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE request_category (request_id INTEGER NOT NULL, category_id INTEGER NOT NULL, PRIMARY KEY(request_id, category_id))');
        $this->addSql('CREATE INDEX IDX_F369F9E4427EB8A5 ON request_category (request_id)');
        $this->addSql('CREATE INDEX IDX_F369F9E412469DE2 ON request_category (category_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__request AS SELECT id, item_ad_id, min_price, max_price FROM request');
        $this->addSql('DROP TABLE request');
        $this->addSql('CREATE TABLE request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_ad_id INTEGER NOT NULL, min_price INTEGER NOT NULL, max_price INTEGER DEFAULT NULL, CONSTRAINT FK_3B978F9F6593CE46 FOREIGN KEY (item_ad_id) REFERENCES item_ad (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO request (id, item_ad_id, min_price, max_price) SELECT id, item_ad_id, min_price, max_price FROM __temp__request');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__request AS SELECT id, item_ad_id, min_price, max_price FROM request');
        $this->addSql('DROP TABLE request');
        $this->addSql('CREATE TABLE request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_ad_id INTEGER NOT NULL, min_price INTEGER NOT NULL, max_price INTEGER DEFAULT NULL, item_name VARCHAR(255) NOT NULL COLLATE BINARY, item_description VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO request (id, item_ad_id, min_price, max_price) SELECT id, item_ad_id, min_price, max_price FROM __temp__request');
        $this->addSql('DROP TABLE __temp__request');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3B978F9F6593CE46 ON request (item_ad_id)');
        $this->addSql('DROP INDEX IDX_32993751F675F31B');
